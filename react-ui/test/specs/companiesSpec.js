...
describe('companies', function() {
  before(function() {
    browser.url('http://localhost:3000/Companies/Media');
  });

  it("finds companies on the page", ()=> {
    expect(browser.getText('.App-body')).to.include('BBC');
  });

  it("should display the overall rating on the page", ()=> {
    expect(browser.getText('.App-body')).to.include('3.8');
  });
  ...
  it("should display website on the page", ()=> {
    expect(browser.getText('.website')).to.include('www.bbc.co.uk');
  });

  it("should display industry on the page", ()=> {
    expect(browser.getText('.industry')).to.include('TV Broadcast & Cable Networks');
  });
